    ...
    <div class="modal fade" id="register-view" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-footer">
                    <button class="btn btn-danger btn-ok text-white" id="eliminar2" <?php echo !$edition? $disable= 'disabled' :$disable= '';?> ><?php echo $level?'Archivar':'Eliminar';?></button>
