        ...
        <div class="container mt-2">
            <div class="row">
                <div class="col-md-6">
                    ...
                    <input type="text" class="" name="code" id="code" placeholder=" Código del producto"/>
                    <br>
                </div>
                <div class="col-md-6">
                    <label for="cliente">Cliente: </label><br>
                    <input type="text" class="" name="cliente" id="cliente" placeholder="Codigo del Cliente"/>
                    <button id="clienteSearch" class="btn btn-success">Buscar</button>
                    <br>
                </div>
            </div>

            <div>
                <h5 id="idCliente" data="0000000000000" >Bienvenido: <span id="NombreCliente"></span></h5>
            </div>
